...
const float4x4& ComponentTransform::ComputeTranslationMatrix(const float3& i_deltaCoords) const
{
...
const float4x4& ComponentTransform::ComputeRotationMatrix(const float3& i_thetasRad) const
{
...
const float4x4& ComponentTransform::ComputeScaleMatrix(const float3& i_deltaScale) const
{
